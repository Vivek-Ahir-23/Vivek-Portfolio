...
export const SocialLinks: React.FC<SocialLinksProps> = ({
  githubUrl = "https://github.com/Vivek-Ahir-23",
  linkedinUrl = "https://www.linkedin.com/in/shyara-vivek-029771283/",
  whatsappUrl = "https://wa.me/918140618829",
  ...
  const links = [
    ...
    },
    {
      ...
      href: githubUrl,
      icon: (
        <svg className="w-4 h-4 fill-current text-[#c084fc]" viewBox="0 0 24 24">
